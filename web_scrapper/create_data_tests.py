...
class TestCreateData(unittest.TestCase):
    def test_create_player_data(self):
        ...
        skill_scores = create_skill_score('skill_scores/testing_skill_scores.out')
        seasons_played = create_seasons_played('rookie_seasons/testing_rookie_seasons_data.out')
        player_data = create_player_data(dst_rankings, dst_encodings, skill_scores, seasons_played, 7,
                                         'weekly_data/testing_weekly_data.out')
